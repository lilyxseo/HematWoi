        ...
        <div className="mt-2 flex-1 overflow-y-auto pr-1">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-border/60 bg-surface-1/95 p-4">
              ...
              <p className="mt-1 text-xs text-muted">Dari {data.transactionCount} transaksi kemarin.</p>
            </div>
            <div className="rounded-2xl border border-border/60 bg-surface-1/95 p-4">
              ...
              <p className="mt-1 text-xs text-muted">Perbandingan {data.comparisonSentence.toLowerCase()}</p>
            </div>
            <div className="rounded-2xl border border-border/60 bg-surface-1/95 p-4">
            ...
            <div className="rounded-2xl border border-border/60 bg-surface-1/95 p-4">
              <div className="text-xs font-medium uppercase text-muted">Highlight</div>
              <div className="mt-2 text-sm text-text">{data.suggestion}</div>
            </div>
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-between gap-2">
            ...
            <span className="text-xs text-muted">Ringkasan akan muncul otomatis saat login berikutnya.</span>
          </div>
        </div>
      </div>
    </div>,
