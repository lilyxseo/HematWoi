...
export default function DayCell({
  ...
  let mobileAmountDisplay = '—';
  let mobileAmountClass = 'text-slate-400';

  if (expense > 0) {
    mobileAmountDisplay = formatIDShort(-expense);
    mobileAmountClass = 'text-rose-400';
  } else if (income > 0) {
    const incomeShort = formatIDShort(income);
    mobileAmountDisplay = incomeShort.startsWith('-') ? incomeShort : `+${incomeShort}`;
    mobileAmountClass = 'text-emerald-400';
  }
