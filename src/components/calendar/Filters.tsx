...
const typeOptions: {
  ...
  { value: 'all', label: 'Exp+Inc', icon: ArrowsUpDown },
];
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <div className="flex min-w-0 flex-col gap-2">
            ...
            <div
              ...
              className="flex flex-wrap items-center justify-center gap-2 text-sm sm:justify-start"
            >
                  ...
                  <button
                    ...
                    onKeyDown={(event) => {
                      ...
                      if (event.key === 'ArrowRight' || event.key === 'ArrowLeft') {
                        ...
                        handleTypeChange(typeOptions[nextIndex].value);
                        return;
                      }
                    ...
                    className={
                      'inline-flex h-9 items-center gap-1.5 rounded-full px-3 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] md:px-4 ring-1 '
                      + (isActive
                        ? 'bg-[var(--accent)]/15 text-[var(--accent)] ring-[var(--accent)]'
                        : 'text-slate-300 ring-slate-700/60 hover:bg-slate-800/60')
                      + (filtersBusy ? ' cursor-wait opacity-70' : '')
                    }
                  >
