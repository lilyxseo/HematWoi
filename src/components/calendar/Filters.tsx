...
export default function Filters({
  ...
  const renderSearchField = () => (
    <label className="flex min-w-0 flex-col gap-2">
      ...
      <input
        ...
        className="h-10 rounded-xl border border-slate-700 bg-slate-900 px-3 text-sm text-slate-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
      />
    </label>
  );
  ...
  const renderAdvancedFilters = () => (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div className="flex min-w-0 flex-col gap-2 md:col-span-2 lg:col-span-3 xl:col-span-4">
        <span className="text-xs font-semibold uppercase tracking-wide text-slate-400">
          Rentang nominal (IDR)
        </span>
    ...
    <section aria-label="Filter kalender" className="rounded-3xl border border-slate-800 bg-slate-950/70 p-4 shadow-sm">
        ...
        <div className="flex flex-col gap-3 md:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-900 px-3 text-sm font-semibold text-slate-200 transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
      ...
      <Transition show={sheetOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50 md:hidden" onClose={setSheetOpen}>
          ...
          <div className="fixed inset-0 flex flex-col justify-end p-0">
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-200"
            ...
            >
              <Dialog.Panel className="flex h-[90vh] w-full max-w-full flex-col overflow-hidden rounded-t-3xl border border-slate-800 bg-slate-950">
                ...
                <div className="no-scrollbar max-h-[65vh] overflow-y-auto px-4 py-4">
                  <div className="flex flex-col gap-4">
                    {renderSearchField()}
                    {renderAdvancedFilters()}
                  </div>
                ...
                <div className="flex items-center justify-between gap-3 border-t border-slate-800 px-4 py-3">
                  {hasActiveFilters ? (
                    <span className="text-xs font-medium text-slate-300">Filter aktif</span>
                  ) : (
                    <span className="text-xs text-slate-500">Tidak ada filter tambahan</span>
                  )}
                  <button
                    type="button"
                    onClick={() => {
