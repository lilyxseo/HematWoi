...
export default function Filters({
  ...
  const renderSearchInput = (className = '') => (
    <input
      ...
      className={`h-10 rounded-2xl border border-slate-700 bg-slate-900 px-3 text-sm text-slate-200 transition placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] sm:h-11 ${className}`}
    />
  );

  const FilterGrid = ({ includeSearch = true }: { includeSearch?: boolean }) => (
  ...
  return (
    <section aria-label="Filter kalender" className="rounded-3xl border border-slate-800 bg-slate-950/70 p-4 shadow-sm">
        ...
        <div className="flex flex-col gap-3 sm:hidden">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex h-10 flex-1 items-center justify-center gap-2 rounded-2xl border border-slate-700 bg-slate-900 px-3 text-sm font-semibold text-slate-200 transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
            >
            ...
            <button
              type="button"
              onClick={onReset}
              className="inline-flex h-10 items-center justify-center rounded-2xl border border-slate-700 bg-slate-900 px-3 text-sm font-semibold text-slate-200 transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
      ...
      <Transition show={sheetOpen} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={setSheetOpen}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 overflow-hidden">
            <div className="flex min-h-full flex-col justify-end px-3 py-4 sm:items-center sm:justify-center sm:p-6">
              <Transition.Child
                as={Fragment}
                enter="ease-out duration-200"
              ...
              >
                <Dialog.Panel className="w-full rounded-t-3xl border border-slate-800 bg-slate-950 p-4 text-left shadow-xl transition-all sm:max-w-lg sm:rounded-3xl">
                  <div className="flex items-start justify-between gap-3">
                    <Dialog.Title className="text-base font-semibold text-slate-100">Filter lanjutan</Dialog.Title>
                    <button
                      type="button"
                  ...
                  <div className="mt-6 flex justify-end gap-3">
                    ...
                    <button
                      type="button"
                      onClick={() => setSheetOpen(false)}
                      className="inline-flex h-10 items-center justify-center rounded-2xl bg-[var(--accent)] px-4 text-sm font-semibold text-white transition hover:bg-[var(--accent)]/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]/40"
                    >
                      Selesai
                    </button>
                  </div>
