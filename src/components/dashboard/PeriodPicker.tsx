        ...
        {SEGMENTS.map((segment) => {
          ...
          return (
            <button
              ...
              className={`inline-flex min-h-10 min-w-[40px] items-center justify-center gap-2 rounded-xl px-3 py-1.5 font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
                isActive
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3 text-xs sm:text-sm">
          <label className="flex min-w-[140px] flex-1 flex-col gap-1">
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-transparent bg-muted/40 px-3 text-sm shadow-inner ring-2 ring-transparent focus:border-primary/40 focus:bg-background focus:outline-none focus:ring-primary/20 sm:px-4 sm:text-base"
              />
          </label>
          <label className="flex min-w-[140px] flex-1 flex-col gap-1">
