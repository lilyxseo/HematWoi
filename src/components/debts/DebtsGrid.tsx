            ...
            >
              ...
              <header className="relative z-10 flex flex-col gap-4">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between lg:gap-6">
                  ...
                  <div className="flex flex-col items-start gap-3 text-sm text-muted lg:items-end lg:text-right">
              ...
              <footer className="relative z-10 flex flex-col gap-3 text-sm text-muted sm:flex-col md:flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="flex flex-col gap-2 sm:flex-col md:flex-col lg:flex-1 lg:max-w-md">
                  <button
                    type="button"
                    onClick={() => onAddPayment(debt)}
                    className="inline-flex w-full min-w-[180px] items-center justify-center gap-2 rounded-2xl bg-brand px-4 py-2.5 text-sm font-semibold text-brand-foreground transition hover:brightness-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--brand-ring)] lg:max-w-sm"
                ...
                <div className="flex flex-col gap-2 sm:flex-col sm:items-stretch md:flex-row md:items-center md:justify-end md:gap-3 lg:w-auto">
                  <button
                    type="button"
                    onClick={() => onEdit(debt)}
                    className="inline-flex w-full min-w-[150px] items-center justify-center gap-2 rounded-2xl border border-border/60 bg-surface/70 px-4 py-2.5 text-sm font-semibold text-text transition hover:-translate-y-0.5 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40 md:w-auto"
                  ...
                  <button
                    ...
                    className="inline-flex h-11 w-full items-center justify-center rounded-2xl border border-border/60 bg-surface/70 text-rose-300 transition hover:-translate-y-0.5 hover:bg-rose-500/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400/60 md:h-11 md:w-11 md:rounded-full"
