    ...
    <div className="space-y-1.5">
      <div className="relative">
        <input
          ...
          {...props}
          className="peer min-h-[44px] w-full rounded-2xl border border-border-subtle bg-surface-alt px-3 pb-1 pt-4 text-sm text-text transition-colors placeholder:text-transparent focus-visible:border-border-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/45 disabled:cursor-not-allowed disabled:opacity-60 read-only:bg-surface"
        />
        <label
          htmlFor={id}
