      ...
      <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start lg:gap-8">
        <div className="flex min-w-0 flex-col gap-6">
          <header className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2 overflow-x-auto rounded-2xl border border-slate-800/60 bg-slate-950/70 px-3 py-2 no-scrollbar">
              <button
                type="button"
                onClick={handlePrevMonth}
                className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-200 transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
                aria-label="Bulan sebelumnya"
              >
                <ChevronLeft className="h-5 w-5" />
              </button>
              <div className="whitespace-nowrap rounded-2xl border border-slate-700 bg-slate-900 px-4 py-1.5 text-sm font-semibold text-slate-200">
                {monthLabel}
              </div>
              <button
                type="button"
              ...
              <button
                type="button"
                onClick={handleToday}
                className="inline-flex h-10 shrink-0 items-center justify-center rounded-2xl border border-slate-700 bg-slate-900 px-4 text-sm font-semibold text-slate-200 transition hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
