...
export default function TransactionAdd({ onAdd }) {
  ...
  const selectedAccountBalanceLabel = useMemo(() => {
    ...
    const balanceValue =
      selectedAccount.type === 'cash' ? cashBalance ?? 0 : nonCashBalance ?? 0;
    return formatCurrency(balanceValue, 'IDR');
  }, [selectedAccount, balancesLoading, balancesError, cashBalance, nonCashBalance]);
