      ...
      <Section first>
        <div className="card space-y-6">
          ...
          <div className="flex flex-col gap-6">
            <div className="grid gap-4 lg:grid-cols-2 lg:gap-4 xl:grid-cols-[1.35fr_1fr_1.2fr_1.6fr] xl:gap-6">
              ...
              <div className="space-y-1.5 lg:col-span-2 xl:col-span-1">
                ...
                <textarea
                  ...
                  rows={3}
                  className="min-h-[56px] w-full rounded-2xl border border-border-subtle bg-surface-alt px-4 py-3 text-sm text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
          ...
          <div className="flex flex-col gap-3 rounded-2xl bg-surface-alt/70 p-4 text-sm text-muted lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-0.5 lg:max-w-[60%]">
              {budgetsLoading ? (
        ...
        <div className="card space-y-6">
          ...
          {items.length ? (
            <div className="space-y-5">
              <div className="hidden grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,140px)_minmax(0,120px)_auto] items-center gap-4 rounded-2xl bg-surface-alt px-5 py-3 text-xs font-semibold text-muted md:grid">
                <div>Kategori</div>
                <div>Nominal (Rp)</div>
                <div>Persentase</div>
                <div>Carryover</div>
              ...
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.categoryId}
                    className={clsx(
                      'grid gap-4 rounded-2xl border px-5 py-4 text-sm text-text transition md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,140px)_minmax(0,120px)_auto]',
                      rowHighlight,
                    )}
                  >
