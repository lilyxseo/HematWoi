      ...
      <Section first>
        <div className="card space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid gap-y-4 gap-x-6 lg:grid-cols-2 xl:grid-cols-[minmax(0,0.28fr)_minmax(0,0.22fr)_minmax(0,0.26fr)_minmax(0,1fr)]">
              <CurrencyInput
                label="Nominal Gaji"
                value={salaryAmount}
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="min-h-[3rem] w-full rounded-2xl border border-border-subtle bg-surface-alt px-4 py-3 text-sm text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
                  placeholder="Catatan tambahan untuk simulasi ini"
                />
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-4 rounded-2xl bg-surface-alt/70 p-4 text-sm text-muted md:flex-row md:items-end md:justify-between">
            ...
            <Link
              to="/budgets"
              className={clsx(
                'inline-flex h-12 items-center gap-2 rounded-2xl border border-brand/40 px-5 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40 md:ml-auto',
                hasMonthlyBudget
        ...
        <div className="card space-y-6">
          ...
          {items.length ? (
            <div className="space-y-5">
              <div className="hidden grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,140px)_minmax(0,120px)_auto] items-center gap-5 rounded-2xl bg-surface-alt px-5 py-3.5 text-xs font-semibold text-muted md:grid">
                <div>Kategori</div>
                <div>Nominal (Rp)</div>
                <div>Persentase</div>
                <div>Carryover</div>
              ...
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.categoryId}
                    className={clsx(
                      'grid gap-5 rounded-2xl border px-5 py-4 text-sm text-text transition md:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,140px)_minmax(0,120px)_auto]',
                      rowHighlight,
                    )}
                  >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="rounded-2xl border border-border-subtle bg-surface-alt px-4 py-3 text-sm font-semibold text-text">
