...
function loadComponent(path: string) {
  switch (path) {
    ...
    case '/reports/pro':
      return lazy(() => import('../pages/reports/ReportsProPage'));
    ...
    case '/budgets/simulation/salary':
      return lazy(() => import('../pages/SalarySimulation'));
    case '/goals':
      return lazy(() => import('../pages/Goals'));
    case '/wishlist':
      return lazy(() => import('../pages/WishlistPage'));
    case '/barang-balikan':
      return lazy(() => import('../pages/BarangBalikan'));
    case '/debts':
    case '/debs':
